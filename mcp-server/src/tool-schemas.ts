...
export const toolSchemas={
 ...
 sts_act:z.object({action_id:z.string().min(1).max(512),request_id:z.string().min(1).max(128).optional(),arguments:z.record(z.string(),z.unknown()).default({}),wait_ms:z.number().int().min(10).max(15000).default(8000)}).strict(),
