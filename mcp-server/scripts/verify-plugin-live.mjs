...
try {
 ...
 console.log(JSON.stringify({step:'PASS',pid:start.pid,session_id:state.session_id,state_id:state.state_id,screen:state.screen,language:state.runtime.language,build:state.runtime.build,test_submissions:state.runtime.test_submissions,tools,reused_same_pid:true,gameplay_actions:0,elapsed_ms:performance.now()-startedAt}));
