// Synthetic backend and local payload counting only. Never runs a game or model.
...
export async function probeWait({dist=path.join(repo,'mcp-server','dist'),mode='event',metrics=false,durationMs=10000,pollMs=1000}={}){
 ...
 const token=randomBytes(32).toString('base64url'),peers=new Set();let version=1,dispatches=0,heartbeat,transition;
