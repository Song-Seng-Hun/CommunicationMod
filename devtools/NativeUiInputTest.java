...
public final class NativeUiInputTest {
    public static void main(String[] args)throws Exception {
        ...
        try{input.getMethod("invoke",Object.class,String.class,Class.class,Object.class);}catch(NoSuchMethodException missing){throw new AssertionError("Missing typed native handler invocation",missing);}
        ...
        System.out.println("PASS: native input scope, synchronous clicks, typed native handlers, inactive/pending guards, cleanup on success/failure");
    }
