...
& "$PSScriptRoot\verify-card-upgrades.ps1" -DownfallPath $DownfallPath
& "$PSScriptRoot\verify-run-usability.ps1" -DownfallPath $DownfallPath
...
& "$PSScriptRoot\verify-map-planner.ps1" -DownfallPath $DownfallPath
